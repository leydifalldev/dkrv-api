...
class ListenersController {
    ...
    registerPatternHandlers(instanceWrapper, server, moduleKey) {
        ...
        patternHandlers.forEach(({ pattern, targetCallback, methodKey, isEventHandler }) => {
            ...
            const asyncHandler = this.createRequestScopedHandler(instanceWrapper, pattern, module, moduleKey, methodKey, defaultCallMetadata);
    ...
    createRequestScopedHandler(wrapper, pattern, module, moduleKey, methodKey, defaultCallMetadata = rpc_metadata_constants_1.DEFAULT_CALLBACK_METADATA) {
