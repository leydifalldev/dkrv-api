...
export default class Step extends Component {
  ...
  render() {
    const { title, icon, index, active, completed, first, isLast, href, onClick, wait } = this.props;
...
const Circle = ({ link, href, onClick, styles, stepContent }) => {
  return link ?
